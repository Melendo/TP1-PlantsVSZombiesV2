...
public class Messages {
	...
	public static final String POSITION_FILLED = "Position already ocupied";
	...
	public static final String SF_PLANTED = "Sunflower planted";
	
	public static final String PS_PLANTED = "Peashoter planted";
